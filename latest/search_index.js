...

{
    ...
    "category": "Function",
    "text": "addvariable!(m::AbstractMathProgModel, N::Int)\n\nAdd a scalar variable to the model, returning a vector of variable references.\n\n\n\n"
},
...

{
    ...
    "category": "Method",
    "text": "isconstrlinear(::AbstractNLPEvaluator, i::Integer)\n\ntrue if the i	extth constraint is known to be linear, false otherwise.\n\n\n\n"
},
